    ...
    def create_field_buttons(self, team_color):
        ...
        if team_color == "red":
            ...
            button_positions = [
                ...
                (78,  674,   '12R',  6, "#99ccff"),   # ID 12R
                (113, 717,   '12C',  5, "#99ccff"),   # ID 12C
                (142, 760,   '12L',  4, "#99ccff"),   # ID 12L
                (639, 674,   '13L',  3, "#99ccff"),   # ID 13L
                (610, 717,   '13C',  2, "#99ccff"),   # ID 13C
                (573, 760,   '13R',  1, "#99ccff"),   # ID 13R
                (653, 322,    '16',  7, "#99ccff"),   # ID 16
                (526, 172,    '14',  8, "#99ccff"),   # ID 14
                (191, 172,    '15',  9, "#99ccff"),   # ID 15
                (267, 525,   '17R', 15, "#99ccff"),   # ID 17R
                (240, 480,   '17L', 14, "#99ccff"),   # ID 17L
                (391, 553,   '18R', 13, "#99ccff"),   # ID 18R
                (327, 553,   '18L', 12, "#99ccff"),   # ID 18L
                (479, 480,   '19R', 11, "#99ccff"),   # ID 19R
                (452, 525,   '19L', 10, "#99ccff"),   # ID 19L
                (452, 357,   '20R', 21, "#99ccff"),   # ID 20R
                (479, 402,   '20L', 20, "#99ccff"),   # ID 20L
                (391, 325,   '21L', 18, "#99ccff"),   # ID 21R
                (327, 325,   '21R', 19, "#99ccff"),   # ID 21L
                (267, 357,   '22L', 16, "#99ccff"),   # ID 22R
                (240, 402,   '22R', 17, "#99ccff"),   # ID 22L
            ]
