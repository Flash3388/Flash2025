...
public class RobotMap {
    ...
    // coral arm
    public static final int ARM_CORAL_MOTOR = 9;
    public static final double ARM_CORAL_KP = 0.1;
    ...
    public static final double ARM_CORAL_TOLERANCE_POSITION_DEGREES = 0;
    public static final double ARM_CORAL_TOLERANCE_VELOCITY_RPM = 0;
    ...
    public static final double ARM_CORAL_ANGLE_A = 10;
    public static final double ARM_CORAL_ANGLE_B = 30;
